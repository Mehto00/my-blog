...
const Bio = () => {
  ...
  return (
    <div className={bioStyles.wrapper}>
      ...
      <div>
        <p>
          Hi! I'm <strong>Mikko</strong> and I'm a developer. I live and work in
          Helsinki.
          <br />
          <br />
          ...
          off I went back to school and learned how to code. After graduating at
          2018 I started earning my living as a developer.
          <br />
          <br />
